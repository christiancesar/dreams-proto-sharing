...
var flight_flights_pb = require('../flight/flights_pb.js');
var google_protobuf_empty_pb = require('google-protobuf/google/protobuf/empty_pb.js');

function serialize_flight_FlightCreateRequest(arg) {
  if (!(arg instanceof flight_flights_pb.FlightCreateRequest)) {
...
function deserialize_flight_FlightCreateRequest(buffer_arg) {
  return flight_flights_pb.FlightCreateRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_flight_FlightListResponse(arg) {
  if (!(arg instanceof flight_flights_pb.FlightListResponse)) {
...
function deserialize_flight_FlightListResponse(buffer_arg) {
  return flight_flights_pb.FlightListResponse.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_flight_FlightOffersRequest(arg) {
  if (!(arg instanceof flight_flights_pb.FlightOffersRequest)) {
...
function deserialize_flight_FlightOffersRequest(buffer_arg) {
  return flight_flights_pb.FlightOffersRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_flight_FlightOffersResponse(arg) {
  if (!(arg instanceof flight_flights_pb.FlightOffersResponse)) {
...
function deserialize_flight_FlightOffersResponse(buffer_arg) {
  return flight_flights_pb.FlightOffersResponse.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_flight_FlightResponse(arg) {
  if (!(arg instanceof flight_flights_pb.FlightResponse)) {
...
function deserialize_flight_FlightResponse(buffer_arg) {
  return flight_flights_pb.FlightResponse.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_flight_FlightShowRequest(arg) {
  if (!(arg instanceof flight_flights_pb.FlightShowRequest)) {
...
function deserialize_flight_FlightShowRequest(buffer_arg) {
  return flight_flights_pb.FlightShowRequest.deserializeBinary(new Uint8Array(buffer_arg));
}
...
var FlightsService = exports.FlightsService = {
  searchFlightOffer: {
    ...
    requestType: flight_flights_pb.FlightOffersRequest,
    responseType: flight_flights_pb.FlightOffersResponse,
  ...
  createFlight: {
    ...
    requestStream: false,
    responseStream: false,
    requestType: flight_flights_pb.FlightCreateRequest,
    responseType: flight_flights_pb.FlightResponse,
  ...
  listFlights: {
    ...
    responseType: flight_flights_pb.FlightListResponse,
  ...
  showFlight: {
    ...
    requestStream: false,
    responseStream: false,
    requestType: flight_flights_pb.FlightShowRequest,
    responseType: flight_flights_pb.FlightResponse,
